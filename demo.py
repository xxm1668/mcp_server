...
API_URL = f"https://ai-generic-gpt4o.openai.azure.com/openai/deployments/gpt4o/chat/completions?api-version=2024-02-15-preview"
"""处理用户查询请求"""
# 获取历史记录
...
- 保持逻辑清晰，分析过程透明"""}
    ...
    },
    {
        ...
        "content": [
            {"type": "image_url",
             "image_url": {
                 'url': 'https://dify2.365sydc.com/files/eda6fe4d-06a9-4d5b-adcd-f4f4d6a7ba37/file-preview?timestamp=1754557032&nonce=1f111d879f757c94ee00cea2df5d9122&sign=8hgsdSgxHOyLU4G3aRXVGtZ8WaBHr8ClKoPxi7ggR8A='}},
        ],
    },
]
...
HEADERS = {
    ...
    "api-key": "1f8ece333fa441f0aeb0d3a85880c747"
}
try:
    _start = time.time()
